...
namespace Atavism
{
    ...
    public class AtavismRdpPacket
    {
        ...
        public AtavismRdpPacket(byte[] data)
        {
            this.data = data;
        }

        public AtavismRdpPacket(int dataLength) : this(dataLength, 0)
        {
        }
        ...
        public AtavismRdpPacket(int dataLength, int optionLength)
        {
        ...
        public int[] EakEntries
        {
            ...
            set
            {
                System.Diagnostics.Debug.Assert(4 * value.Length + Offset.VariableHeaderArea == HeaderLength * 2,
