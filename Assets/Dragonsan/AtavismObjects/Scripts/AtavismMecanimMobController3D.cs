    ...
    public class AtavismMecanimMobController3D : MobController3D
    {
        ...
        void LateUpdate()
        {
            ...
            else if (_animator)
            {
                ...
                if (pathInterpolator != null)
                {
                    ...
                    _animator.SetFloat("Speed2D", pathInterpolator.Speed);
                }
                else
                {
                    if (mount != null)
      ...
      /*  public void HandleWeapon2Type(object sender, PropertyChangeEventArgs args)
        ...
        public override void PlayAnimation(string animationName, float length, string modSpeedParam, float modSpeed)
        {
            ...
            if (_animator != null && !string.IsNullOrEmpty(modSpeedParam))
            {
                _animator.SetFloat(modSpeedParam, modSpeed);
            }
        ...
        public override void PlayAnimationTrigger(string animNameTrigger, string modSpeedParam, float modSpeed)
        {
            if (_animator != null && !string.IsNullOrEmpty(modSpeedParam))
            {
                _animator.SetFloat(modSpeedParam, modSpeed);
