...
namespace Atavism
{
    ...
    public class AtavismWeatherManager : MonoBehaviour
    {
        ...
        [HideInInspector][SerializeField] protected float Humidity = 0f;
        [HideInInspector][SerializeField] protected float WindDirection = 0f;
        [HideInInspector][SerializeField] protected float WindSpeed = 0f;
        [HideInInspector][SerializeField] protected float WindTurbulence = 0f;
        [HideInInspector][SerializeField] protected float FogHeightPower = 0f;
        [HideInInspector][SerializeField] protected float FogHeightMax = 0f;
        [HideInInspector][SerializeField] protected float FogDistancePower = 0f;
        [HideInInspector][SerializeField] protected float FogDistanceMax = 0f;
        [HideInInspector][SerializeField] protected float RainPower = 0f;
        [HideInInspector][SerializeField] protected float RainPowerTerrain = 0f;
        [HideInInspector][SerializeField] protected float RainMinHeight = 0f;
        [HideInInspector][SerializeField] protected float RainMaxHeight = 0f;
        [HideInInspector][SerializeField] protected float HailPower = 0f;
        [HideInInspector][SerializeField] protected float HailPowerTerrain = 0f;
        [HideInInspector][SerializeField] protected float HailMinHeight = 0f;
        [HideInInspector][SerializeField] protected float HailMaxHeight = 0f;
        [HideInInspector][SerializeField] protected float SnowPower = 0f;
        [HideInInspector][SerializeField] protected float SnowPowerTerrain = 0f;
        [HideInInspector][SerializeField] protected float SnowMinHeight = 0f;
        [HideInInspector][SerializeField] protected float SnowAge = 0f;
        [HideInInspector][SerializeField] protected float ThunderPower = 0f;
        [HideInInspector][SerializeField] protected float CloudPower = 0f;
        [HideInInspector][SerializeField] protected float CloudMinHeight = 0f;
        [HideInInspector][SerializeField] protected float CloudMaxHeight = 0f;
        [HideInInspector][SerializeField] protected float CloudSpeed = 0f;
        [HideInInspector][SerializeField] protected float MoonPhase = 0f;
        [HideInInspector][SerializeField] protected float Season = 0f;
        [HideInInspector][SerializeField] protected int year = 1;
        [HideInInspector][SerializeField] protected int month = 1;
        [HideInInspector][SerializeField] protected int day = 1;
        [HideInInspector][SerializeField] protected int hour = 0;
        [HideInInspector][SerializeField] protected int min = 0;
        [HideInInspector][SerializeField] protected float second = 0;
        [HideInInspector][SerializeField] protected float worldTimeSpeed = 1;
        [AtavismSeparator("")]
        [HideInInspector][SerializeField] protected float TemperatureDelta = 0f;
        [HideInInspector][SerializeField] protected float HumidityDelta = 0f;
        [HideInInspector][SerializeField] protected float WindDirectionDelta = 0f;
        [HideInInspector][SerializeField] protected float WindSpeedDelta = 0f;
        [HideInInspector][SerializeField] protected float WindTurbulenceDelta = 0f;
        [HideInInspector][SerializeField] protected float FogHeightPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float FogHeightMaxDelta = 0f;
        [HideInInspector][SerializeField] protected float FogDistancePowerDelta = 0f;
        [HideInInspector][SerializeField] protected float FogDistanceMaxDelta = 0f;
        [HideInInspector][SerializeField] protected float RainPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float RainPowerTerrainDelta = 0f;
        [HideInInspector][SerializeField] protected float RainMinHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float RainMaxHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float HailPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float HailPowerTerrainDelta = 0f;
        [HideInInspector][SerializeField] protected float HailMinHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float HailMaxHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float SnowPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float SnowPowerTerrainDelta = 0f;
        [HideInInspector][SerializeField] protected float SnowMinHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float SnowAgeDelta = 0f;
        [HideInInspector][SerializeField] protected float ThunderPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float CloudPowerDelta = 0f;
        [HideInInspector][SerializeField] protected float CloudMinHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float CloudMaxHeightDelta = 0f;
        [HideInInspector][SerializeField] protected float CloudSpeedDelta = 0f;
        [HideInInspector][SerializeField] protected float MoonPhaseDelta = 0f;
        [HideInInspector][SerializeField] protected float SeasonDelta = 0f;
        [HideInInspector][SerializeField] protected string profile = "";
