...
namespace Atavism
{
    ...
    public class AtavismEventMessageHandler : MonoBehaviour
    {
        ...
        public virtual void HandleGeneralEvent(Dictionary<string, object> props)
        {
            ...
            else if (eventType == "StatIncrease")
            {
            /*    string[] cArgs = new string[3];
#if AT_I2LOC_PRESET
            cArgs[0] =  I2.Loc.LocalizationManager.GetTranslation("Repair Succeeded");
            ...
            else if (eventType == "ClaimPurchased")
            {
                string[] cArgs = new string[3];
#if AT_I2LOC_PRESET
            cArgs[0] =  I2.Loc.LocalizationManager.GetTranslation("Claim Purchased");
#else
                cArgs[0] = "Claim Purchased.";
#endif
                cArgs[1] = "System";
                cArgs[2] = "";
                AtavismEventSystem.DispatchEvent("CHAT_MSG_SYSTEM", cArgs);
        ...
        public virtual void ProcessErrorEvent(string eventType, int val, string data)
        {
            ...
            else if (eventType == "EquipMissing")
            {
                ...
                {
#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("Requires an")+" " + data + " "+I2.Loc.LocalizationManager.GetTranslation("equipped");
#else
                    errorMessage = "Requires an " + data + " equipped";
#endif
                }
                else
                {
#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("Requires a")+" " + data + " "+I2.Loc.LocalizationManager.GetTranslation("equipped");
#else
                    errorMessage = "Requires a " + data + " equipped";
#endif
                }
            }
            ...
            else if (eventType == "MissingItem")
            {
                AtavismInventoryItem aii = AtavismPrefabManager.Instance.LoadItem(val);
#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("Missing Item") +" "+ (aii != null ? I2.Loc.LocalizationManager.GetTranslation("Items/"+aii.BaseName) : "");
#else
                errorMessage = "Missing Item " + (aii != null ? aii.BaseName : "");
#endif
            }
            else if (eventType == "PlayerShopLimit")
            {

#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("Limit of the shop has reached") ;
#else
                errorMessage = "Limit of the shop has reached";
#endif
            }
            else if (eventType == "PlayerShopWrongInstanceType")
            {

#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("The shop cannot be created in this instance") ;
#else
                errorMessage = "The shop cannot be created in this instance";
#endif
            }
            else if (eventType == "OwnerCantBuySell")
            {

#if AT_I2LOC_PRESET
                errorMessage = I2.Loc.LocalizationManager.GetTranslation("Owner can't buy or sell") ;
#else
                errorMessage = "Owner can't buy or sell";
#endif
            }
            else
            {
        ...
        public virtual void HandleRequirementFailedEvent(Dictionary<string, object> props)
        {
            ...
            errorMessage = I2.Loc.LocalizationManager.GetTranslation("You do not meet the requirements");
                ...
                errorMessage = "You do not meet the requirements";
#endif
            }  else if (eventType == "RequirementResultGuildTooLow")
            {
#if AT_I2LOC_PRESET
            errorMessage = I2.Loc.LocalizationManager.GetTranslation("You do not meet the requirements");
#else
