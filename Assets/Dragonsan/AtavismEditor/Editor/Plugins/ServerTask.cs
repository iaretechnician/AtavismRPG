...
namespace Atavism
{
    ...
    public class ServerTask : AtavismDatabaseFunction
    {

        public new Dictionary<int, TaskData> dataRegister;
        public new TaskData editingDisplay;
        public new TaskData originalDisplay;
        ...
        public ServerTask()
        {
            ...
            tableName = "task";
            functionTitle = "Task Configuration";
            loadButtonLabel = "Load Task";
            notLoadedText = "No Task loaded.";
            // Init
            dataRegister = new Dictionary<int, TaskData>();

            editingDisplay = new TaskData();
            originalDisplay = new TaskData();
        }
        ...
        public override void DrawLoaded(Rect box)
        {
            ...
            if (displayList.Count <= 0)
            {
                ...
                ImagePack.DrawLabel(pos.x, pos.y, Lang.GetTranslate("You must create a Task before editing it."));
                return;
            }

            // Draw the content database info
            ImagePack.DrawLabel(pos.x, pos.y, Lang.GetTranslate("Edit Task"));
            ...
            if (state != State.Loaded)
            {
                ...
                pos.width *= 2;
                pos.y += ImagePack.fieldHeight * 1.5f;
                ImagePack.DrawLabel(pos.x, pos.y, Lang.GetTranslate("Task Properties")+":");
        ...
        public override void DrawEditor(Rect box, bool newItem)
        {
            ...
            if (newEntity)
            {
                ImagePack.DrawLabel(pos.x, pos.y, Lang.GetTranslate("Create a new Task"));
                pos.y += ImagePack.fieldHeight;
            }
