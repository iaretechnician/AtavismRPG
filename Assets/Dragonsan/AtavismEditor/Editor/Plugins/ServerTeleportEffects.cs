...
namespace Atavism
{
    ...
    public class ServerTeleportEffects : ServerEffectType
    {

        public new string effectType = "Teleport";
        public new string[] effectTypeOptions = new string[] { "TeleportEffect" };
        public string[] teleportTypeOptions = new string[] { "Standard", /*"Item",*/ "To Target" };

        public int[] instanceIds = new int[] { -1 };
        public string[] instanceOptions = new string[] { "~ none ~" };

        // Use this for initialization
        public ServerTeleportEffects()
        {
        }
        ...
        {
            editingDisplay.stringValue1 = ImagePack.DrawSelector(pos, Lang.GetTranslate("Teleport Type")+":", editingDisplay.stringValue1, teleportTypeOptions);
            pos.y += ImagePack.fieldHeight*1.5f;
            if (editingDisplay.stringValue1 == "Standard")
            {
