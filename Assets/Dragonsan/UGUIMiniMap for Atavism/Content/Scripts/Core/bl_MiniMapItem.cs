    ...
    public class bl_MiniMapItem : MonoBehaviour
    {
        ...
        void CreateIcon()
        {
            ...
            if (GraphicPrefab == null)
                GraphicPrefab = AtavismSettings.Instance.MinimapSettings.minimapItemPrefab;
            ...
            {
                Graphic.sprite = AtavismSettings.Instance.MinimapSettings.minimapIcon;
        ...
        void Update()
        {
            ...
            {
                CircleAreaRect.anchoredPosition = UnClampPosition;
            }
        ...
        public void SetColor(Color col)
        {
            ...
            if(cacheItem.GetComponent<Image>().color != col)
                cacheItem.GetComponent<Image>().color = col;
        }
