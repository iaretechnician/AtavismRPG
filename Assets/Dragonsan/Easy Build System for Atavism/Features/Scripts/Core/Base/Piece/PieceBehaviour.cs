...
//Debug.LogError("Update Placed="+Placed);
        ...
        {
           // Debug.LogWarning("ChangeState CurrentState=" + CurrentState + " newState=" + state + " LastState=" + LastState + " BuilderBehaviour.Instance.AllowPlacement=" + (BuilderBehaviour.Instance != null ? BuilderBehaviour.Instance.AllowPlacement + "" : "bd"));
            ...
            if (state == StateType.Queue)
            {
                ...
                //gameObject.ChangeAllMaterialsColorInChildren(Renderers.ToArray(), Color.white);
               // var pb = gameObject.GetComponent<PieceBehaviour>();
               //Debug.LogError("Changestate "+Renderers.Count+" "+InitialRenderers.Count);
            ...
            {
              //  Debug.LogError("PreviewAllowedColor Preview");
               // gameObject.ChangeAllMaterialsInChildren(Renderers.ToArray(), PreviewMaterial);
                gameObject.ChangeAllMaterialsColorInChildren(Renderers.ToArray(), BuilderBehaviour.Instance.AllowPlacement ? PreviewAllowedColor : PreviewDeniedColor);
            ...
            else if (state == StateType.Edit)
            {
              ...
              //  gameObject.ChangeAllMaterialsInChildren(Renderers.ToArray(), PreviewMaterial);
                gameObject.ChangeAllMaterialsColorInChildren(Renderers.ToArray(), BuilderBehaviour.Instance.AllowEdition ? PreviewAllowedColor : PreviewDeniedColor);
